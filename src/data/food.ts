export const food = {
	...
	breakfast: [
		...
		'mamas fruit cobbler',
		'shirleys plain or blueberry muffins',
		...
		'lizs morning glory muffins',
		'scrambled eggs oeufs brouills',
		'nats cucumber cream cheese bagel',
		'easy breakfast casserole',
		'6 week bran muffins auntie annes muffins',
		...
		'chef flowers simple sunday brunch omelette',
		...
		'pumpkin french toast with toasted walnuts',
		...
		'vanilla fruit dip',
		'eggs in a basket',
		'grandmas swedish thin pancakes',
	...
	lunch: [
		...
		'fried almonds',
		'the greatful bread sandwich',
		'egg salad club sandwiches or shrimp salad club',
		'nifs peanut butter banana muffins',
		...
		'katos tasty salmon cream cheese surprise',
		...
		'delicious and simple fruit dip',
		...
		'beef for tacos',
		'hidden valley wraps',
		'omas boterkoek dutch buttercake',
		'apple butterflies',
		'don t burn your fingers garlic bread',
		...
		'hummus with a twist',
		'bellissimo panini',
		'carls jr western bacon cheeseburger copycat by todd wilbur',
	...
	dinner: [
		'kittencals caesar tortellini salad',
		'no bake hersheys bar pie',
		'lindas special potato salad',
		'kittencals parmesan orzo',
		'pearls sesame noodles',
		'roasted potatoes and green beans',
		'kittencals really great old fashioned lemonade',
		'lindas chunky garlic mashed potatoes',
		'kittencals pan fried asparagus',
		'cafe mocha latte',
		'fresh tomato and cucumber salad',
		...
		'hoisin marinated wing pieces',
		'feta marinated',
		'the realtors cream cheese corn',
		'savory pita chips',
		...
		'just like deweys candied walnut and grape salad',
		'strawberry pavlova',
		...
		'emerils stewed black eyed peas',
		...
		'kittencals banana almond muffins with almond streusel',
		'ww shrimp scampi',
		'kittencals tender microwave corn with husks on',
		'nude beach',
		'kittencals greek garden salad with greek style dressing',
		'roasted broccoli with cherry tomatoes',
		'kittencals chicken cacciatore',
		...
		'uncle bills caesar canadian style',
		...
		'lubys cafeteria butternut brownie pie',
		...
		'curried pea soup',
		'long island iced tea applebees tgi fridays style',
		'chocolate coconut dream bars',
		'bbq salmon filet',
		'blue margaritas',
		'sweet and sour pork balls',
	...
	dessert: [
		...
		'midsummer swedish strawberry compote  jordgubbskrm',
		...
		'death by chocolate cake',
		'moms southern pecan pie',
		'the best brownies ever',
		'jerrys chocolate ice cream',
		'strawberry angel trifle',
		...
		'grammie millers swedish apple pie',
		'glendas flourless peanut butter cookies',
		'my best banana pudding dessert',
		'viskos praline sauce',
		'perfect purple punch',
		'reindeer bark',
		'lindas bloodshot eyeballs',
		'moroccan fruit salad',
		'apple dumpling bake',
		'simons pumpkin bread pudding',
		...
		'strawberry and cream cheese parfait',
		'apple dessert quick',
		'betty crocker chocolate chip cookies 1971 mens favorites 22',
		'so there reeses peanut butter bars',
		'moms buttery apple cake',
		'chocolate almond roca bar',
		'turtles',
		'sesame toffee',
		'chocolate rainbow krispies treats',
		...
		'awesome chocolate butterscotch chip cookies',
		...
		'cheesecake pie',
		'aunt zanas amish sugar cookies eggless',
		'amish cream pie',
